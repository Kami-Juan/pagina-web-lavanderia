...
var messages = {
  _default: function (field) { return ("El campo " + field + " no es válido."); },
  alpha_dash: function (field) { return ("El campo" + field + "solo debe contener letras, números y guiones."); },
  alpha_num: function (field) { return ("El campo" + field + " solo debe contener letras y números."); },
  alpha_spaces: function (field) { return ("El campo " + field + " solo debe contener letras y espacios."); },
  alpha: function (field) { return ("El campo " + field + " solo debe contener letras."); },
  ...
  confirmed: function (field) { return ("El campo " + field + " no coincide."); },
  credit_card: function (field) { return ("El campos " + field + " es inválido."); },
  decimal: function (field, ref) {
    if ( ref === void 0 ) ref = ['*'];
    var decimals = ref[0];

    return ("El campo " + field + " debe ser númerico y contener " + (!decimals || decimals === '*' ? '' : decimals) + " puntos decimales.");
},
  ...
  email: function (field) { return ("El campo " + field + " debe ser un correo electrónico válido."); },
  ext: function (field) { return ("El campo " + field + " debe ser un archivo válido."); },
  image: function (field) { return ("El campo " + field + " debe ser una imagen."); },
  in: function (field) { return ("El campo " + field + " debe ser un valor válido."); },
  ip: function (field) { return ("El campo " + field + " debe ser una dirección ip válida."); },
  ...
  mimes: function (field) { return ("El campo " + field + " debe ser un tipo de archivo válido."); },
  min: function (field, ref) {
    var length = ref[0];

    return ("El campo " + field + " debe tener al menos " + length + " caracters.");
},
  ...
  not_in: function (field) { return ("El campo " + field + " debe ser un valor válido."); },
  numeric: function (field) { return ("El campo " + field + " debe contener solo caracteres númericos."); },
  regex: function (field) { return ("El formato del campo " + field + " no es válido"); },
  required: function (field) { return ("El campo " + field + " es obligatorio."); },
  size: function (field, ref) {
    var size = ref[0];

    return ("El campo " + field + " debe ser menor a " + size + " KB.");
},
  url: function (field) { return ("El campo " + field + " no es una URL válida."); }
};
...
var date_between = function (moment) { return function (value, params) {
  ...
  return dateVal.isBetween(minDate, maxDate, 'días', inclusivity);
}; };
...
var messages$1 = {
  ...
  date_format: function (field, ref) {
    ...
    return ("El campo" + field + " debe tener formato " + format + ".");
}
};
